...
public class UI
{
	...
	public void drawPauseScreen(Graphics g)
	{
		...
		// setup placement
		int x = main.getWidth() / 2 - fm.stringWidth(s) / 2;
		int y = main.getWidth() / 2 - fm.getHeight() * 2;
	...
	public void drawFullStatsOverlay(Graphics g)
	{
		...
		g.fillRect(main.getWidth() / 8, main.getHeight() / 8, main.getWidth() - main.getWidth() / 4, main.getHeight() - main.getHeight() / 4);
